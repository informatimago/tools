...
extern int write_string(const char* buffer,FILE* output);
/*
  Writes the buffer onto the output file.
 */

extern  void chop_nl(char* line);
/*
  Remove the new-line and carriage-return characters from the begining
  or the end of the line string.
 */
